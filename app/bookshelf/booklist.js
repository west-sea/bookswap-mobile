...
function MyBooklist() {
    ...
    const historyItems = [
        {
            book1: { title: "A Little Life", author: "Yanagihara, Hanya", image: images.image5 },
            user1: "🌈",
            book2: { title: "Small Things Like These", author: "Claire Keegan", image: images.image4 },
            user2: "🍌",
            date: "03/28",
            swapWith: "Banana"
        },
        {
            book1: { title: "Poems", author: "Louise Gluck", image: images.image6 },
            user1: "🌈",
            book2: { title: "Me Before You", author: "JoJo Moyes", image: images.image6 },
            user2: "🏀",
            date: "03/25",
            swapWith: "Basket Ball"
        }
    ];
    ...
    return (
        <View style={styles.home}>
            <ScrollView style={[styles.scrollContainer, { paddingTop: 120, paddingBottom: 180 }]}>
                {activeTab === 'My Books' ? (
                    <BookList filteredBooks={books} images={images} />
                ) : (
