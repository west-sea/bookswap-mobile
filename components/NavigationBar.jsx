    ...
    return (
        <View style={[styles.navigation, styles.barPosition]}>
            ...
            <Pressable style={[styles.navigationItem, styles.bookItemSpaceBlock]} onPress={() => handlePress('home/home')}>
                {action.action === "home" ? <HomeLine /> : <HomeFill />}
            ...
            <Pressable style={[styles.lg32BookLineParent, styles.bookItemSpaceBlock]} onPress={() => handlePress('bookshelf/booklist')}>
                {action.action === 'booklist' ? <BookFill /> : <BookLine />}
...
const styles = StyleSheet.create({
    ...
    navigation: {
        ...
        width: 360,
        overflow: "hidden",
        backgroundColor: "#FFF",  // Changed from "FFF" to "#FFF"
    }
});
